...
curl --unix-socket /var/run/azure-attestation-proxy/azure-attestation-proxy.sock http://localhost/decrypt -H "x-ms-request-id: 12345678-1234-5678-1234-567812345678"
